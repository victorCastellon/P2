...
"   -1 FLOAT, --alfa1=FLOAT    Increment per determinar el llindar de decisió [default: 1]\n"
"   -2 FLOAT, --alfa2=FLOAT    Increment per determinar el llindar de decisió [default: 10]\n"
